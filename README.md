...
| Area                    | Rating | Finding                                                        |
|-------------------------|--------|----------------------------------------------------------------|
| Book Direct Flow        | 🔴     | Book Now button redirects to Booking.com — no direct option    |
| Brand Search Ownership  | 🟡     | Hotel ranks #1 organic but 3 OTA ads appear above it           |
| Mobile Booking          | 🟡     | Site is responsive but booking flow requires 6 taps to complete|
| Hotel Schema & SEO      | 🔴     | No Hotel schema markup — Google doesn't know this is a hotel   |
| AI Search Visibility    | 🔴     | AI assistants only surface TripAdvisor and Expedia listings    |

## Top 3 Quick Wins

1. Redirect Book Now to your direct booking engine — you're sending guests to an OTA
2. Add Hotel schema markup so Google and AI search engines recognize your property
...
Built by [Lights On Digital](https://lightson.co) — revenue-focused digital strategy for independent hotels.
